...
# flags = tf.app.flags
# flags.DEFINE_string("logdir", "/home/haojianyong/file_1/fudan_TL/saved_models/", "where to save the model")
...
class ConvLayer(tf.layers.Layer):
    ...
    def __init__(self, layer_name, filter_sizes, num_filters, **kwargs):
        self.layer_name = layer_name
...
def max_pool(conv_outs, max_len, num_filters):
    pool_outs = []
...
#     with tf.control_dependencies(update_ops):  # for batch_normalization
#         grads_and_vars_0 = optimizer.compute_gradients(loss)
#         train_op = optimizer.apply_gradients(grads_and_vars_0, global_step=global_step)
#     return train_op
