...
def main_func(_):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            global_step_0 = tf.Variable(0, name="global_step_0", trainable=False)
            ...
            global_step_1 = tf.Variable(0, name="global_step_1", trainable=False)
                    ...
                    for i in range(num_batches_per_epoch_train_0 * FLAGS.num_epochs):  ## for each batch
                        ...
                        if current_step_1 % num_batches_per_epoch_train_0 == 0 or \
                            ...
                            print("train_0: ", current_step_0 / num_batches_per_epoch_train_0,
                                  " epoch, task_0_loss: ", task_0_loss,
                                  "acc: ", train_acc_0,
                                  "loss_adv_0: ", loss_adv_0)

                            print(
                                "train_1: ", current_step_1 / num_batches_per_epoch_train_0,
                                " epoch, task_1_loss: ", task_1_loss,
                                "acc: ", train_acc_1,
                                "loss_adv_1: ", loss_adv_1)
